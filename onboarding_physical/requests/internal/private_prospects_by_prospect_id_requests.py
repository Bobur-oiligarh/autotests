from onboarding_physical.response_data_types.internal.private_prospects_by_id_data_type import \
    PrivateProspectsByIDResponseDataType
from onboarding_physical.test_data.onboarding_physical_context import OnboardingPhysicalContext
from utils.api_utils.test_request import TestRequest
from utils.url_provider import URLProvider


class PrivateProspectsByProspectID(TestRequest):
